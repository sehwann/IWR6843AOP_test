...
.dlls,er4ft .dlls: mmw.per4ft

-include package/cfg/mmw_per4ft.mak
-include package/cfg/mmw_per4ft.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/mmw_per4ft.dep
endif
mmw.per4ft: package/cfg/mmw_per4ft.xdl
	@


ifeq (,$(wildcard .libraries,er4ft))
mmw.per4ft package/cfg/mmw_per4ft.c: .libraries,er4ft
endif

package/cfg/mmw_per4ft.c package/cfg/mmw_per4ft.h package/cfg/mmw_per4ft.xdl: override _PROG_NAME := mmw.xer4ft
package/cfg/mmw_per4ft.c: package/cfg/mmw_per4ft.cfg
package/cfg/mmw_per4ft.xdc.inc: package/cfg/mmw_per4ft.xdl
package/cfg/mmw_per4ft.xdl package/cfg/mmw_per4ft.c: .interfaces

clean:: clean,er4ft
	-$(RM) package/cfg/mmw_per4ft.cfg
	-$(RM) package/cfg/mmw_per4ft.dep
	-$(RM) package/cfg/mmw_per4ft.c
	-$(RM) package/cfg/mmw_per4ft.xdc.inc

clean,er4ft::
	-$(RM) mmw.per4ft
.executables,er4ft .executables: mmw.xer4ft

mmw.xer4ft: |mmw.per4ft

-include package/cfg/mmw.xer4ft.mak
mmw.xer4ft: package/cfg/mmw_per4ft.oer4ft 
	$(RM) $@
	@$(MSG) lnker4ft $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.R4Ft.rootDir)/bin/armlnk -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7R4 --strict_compatibility=on  -o $@ package/cfg/mmw_per4ft.oer4ft   package/cfg/mmw_per4ft.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.R4Ft.rootDir)/lib/libc.a
	
mmw.xer4ft: export C_DIR=
mmw.xer4ft: PATH:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)
mmw.xer4ft: Path:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)

mmw.test test,er4ft test: mmw.xer4ft.test

mmw.xer4ft.test:: mmw.xer4ft
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 mmw.xer4ft.test
else
	@$(MSG) running $<  ...
	$(call EXEC.mmw.xer4ft, ) 
endif

clean,er4ft::
	-$(RM) $(wildcard .tmp,mmw.xer4ft,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
mmw_per4ft.oer4ft,copy : package/cfg/mmw_per4ft.oer4ft
mmw_per4ft.ser4ft,copy : package/cfg/mmw_per4ft.ser4ft
