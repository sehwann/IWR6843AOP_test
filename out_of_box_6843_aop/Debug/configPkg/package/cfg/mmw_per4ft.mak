...
package/cfg/mmw_per4ft.oer4ft: export C_DIR=
package/cfg/mmw_per4ft.oer4ft: PATH:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)
package/cfg/mmw_per4ft.oer4ft: Path:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)

package/cfg/mmw_per4ft.ser4ft: | .interfaces
package/cfg/mmw_per4ft.ser4ft: package/cfg/mmw_per4ft.c package/cfg/mmw_per4ft.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) cler4ft -n $< ...
...
package/cfg/mmw_per4ft.ser4ft: export C_DIR=
package/cfg/mmw_per4ft.ser4ft: PATH:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)
package/cfg/mmw_per4ft.ser4ft: Path:=$(ti.targets.arm.elf.R4Ft.rootDir)/bin/;$(PATH)

clean,er4ft ::
	-$(RM) package/cfg/mmw_per4ft.oer4ft
	-$(RM) package/cfg/mmw_per4ft.ser4ft

mmw.per4ft: package/cfg/mmw_per4ft.oer4ft package/cfg/mmw_per4ft.mak

clean::
	-$(RM) package/cfg/mmw_per4ft.mak
